...
def args_parser():
    ...
    parser.add_argument('--ctx_file',
                        default='ADD_by_yourself/transmission/ts_ckks.config',
                        type=str,
                        help='the number of features')
    ...
    if "Linear".upper() in args.model.upper() or "kmean".upper() in args.model.upper():
        args.rnd = round(5120 / args.batch_size)
    elif "LR" in args.model.upper():
