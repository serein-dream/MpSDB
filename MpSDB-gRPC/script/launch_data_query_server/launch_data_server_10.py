...
def launch_data_server(host, port, delay, name, cfg):
    ...
    server.start()
    print("grpc dataServer_10 start...")
    ...
    print("monitor server_10 service start... ")
...
def main(cfg: DictConfig):
    host = cfg.servers.data_server_10.host
    port = int(cfg.servers.data_server_10.port)
    delay = cfg.defs.delay
    name = cfg.servers.data_server_10.name
