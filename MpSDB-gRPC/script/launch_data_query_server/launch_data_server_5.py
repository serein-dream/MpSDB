...
def launch_data_server(host, port, delay, name, cfg):
    ...
    print("monitor server_5 service start... ")
...
def main(cfg: DictConfig):
    host = cfg.servers.data_server_5.host
    port = int(cfg.servers.data_server_5.port)
    delay = cfg.defs.delay
    name = cfg.servers.data_server_5.name
