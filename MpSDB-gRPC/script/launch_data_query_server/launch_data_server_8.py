...
def launch_data_server(host, port, delay, name, cfg):
    ...
    print("monitor server_8 service start... ")
...
def main(cfg: DictConfig):
    host = cfg.servers.data_server_8.host
    port = int(cfg.servers.data_server_8.port)
    delay = cfg.defs.delay
    name = cfg.servers.data_server_8.name
